...
//       list.add(new File("d:/test/1.txt"));
//list.add(new File("d:/test/2.txt"));
//list.add(new File("d:/test/3.txt"));
//list.add(new File("d:/test/4.txt"));
//try{
//zipFiles(list, new File("d:/abcd.walks"));
//}catch(Exception e){
//System.out.println("ѹ������");
//}
//
//       System.out.println("��˵��һ�仰�ˡ�");
//
//    }
