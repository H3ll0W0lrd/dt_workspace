...
public class FollowList extends FakeActivity implements OnClickListener, OnItemClickListener {
	...
	public void onDestroy() {
		if(adapter != null && adapter.bmChd != null && !adapter.bmChd.isRecycled()){
			adapter.bmChd.recycle();
		}
		if(adapter != null && adapter.bmUnch != null && !adapter.bmUnch.isRecycled()){
			adapter.bmUnch.recycle();
		}
