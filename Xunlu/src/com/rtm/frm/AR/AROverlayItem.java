...
public class AROverlayItem {
	...
	public String getPoiTargetName() {
		return poiTargetName;
	}

	public void setPoiTargetName(String poiTargetName) {
		this.poiTargetName = poiTargetName;
	}
	...
	public void setPoiTargetImageRes(int poiTargetImageRes) {
		this.poiTargetImageRes = poiTargetImageRes;
	}
	
	public int getPoiTargetImageRes() {
		return poiTargetImageRes;
	}
