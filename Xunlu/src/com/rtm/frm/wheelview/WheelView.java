...
public class WheelView extends View {
	...
	private static int VALUE_TEXT_COLOR = 0xFFFFFFFF;//选中文字的颜色

	/** Items text color */
	private static int ITEMS_TEXT_COLOR = 0xFFbb0b19;//选中文字以外的文字颜色
	...
	private static int ADDITIONAL_ITEM_HEIGHT = 20;
...
//		ADDITIONAL_ITEM_HEIGHT = PreferencesUtil.getInt("screenHeight", 800) / 40;
//
//		TEXT_SIZE = PreferencesUtil.getInt("screenHeight", 800) / 50;
		
		ADDITIONAL_ITEM_HEIGHT = (int) context.getResources().getDimension(R.dimen.fragment_map_wheel_text_size);

		TEXT_SIZE = (int) context.getResources().getDimension(R.dimen.fragment_map_wheel_text_size);
	}
...
//					itemsText.append(XunluUtil.formatFloor(text));
...
//			valueLayout = new StaticLayout(text != null ? XunluUtil.formatFloor(text) : "",
...
//					ADDITIONAL_ITEM_HEIGHT, false);
	...
	// return ((StrericWheelAdapter) getAdapter()).getStrContents()
	// .get(getCurrentItem()).getFloor();
	// }
