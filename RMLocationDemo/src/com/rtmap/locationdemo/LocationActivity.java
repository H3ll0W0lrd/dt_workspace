...
public class LocationActivity extends Activity implements OnClickListener,
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		LocationApp.getInstance().setPersistentMotionEnable();// 开启检测参数
		...
		mLocOnline.setOnClickListener(this);
		mLocOffline.setOnClickListener(this);
		mLocMix.setOnClickListener(this);
		if (LocationApp.getInstance().getLbsSign() == LocationApp.MIX) {
			mLocMix.setChecked(true);
		} else if (LocationApp.getInstance().getLbsSign() == LocationApp.OFFLINE) {
...
//				.getApiKey(), new String[] { "860100010030100002",
//				"860100010040500017" }, new OnGetBuildAngleListener() {
//
//			@Override
//			public void onGetBuildAngle(BuildAngleList result) {
//				Log.i("rtmap", mGson.toJson(result));
//			}
//		});
	}
...
//		textView.setText(location.getErrorInfo())
//		LocationApp.getInstance().getScannerInfo();
