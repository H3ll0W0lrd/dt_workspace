...
public class RMlbsUtils {
    ...
    public static final String AIR_BUILD_ID = "860100010030100002";
...
//            ToastUtils.shortToast("map : " + RMVersionMap.VERSION);
    ...
    public void getCityList(final OnRmGetFinishListener listener) {
        if (listener == null) {
            return;
        }
        // 判断本地是否已经有数据
     ...
     */
    @SuppressWarnings("unchecked")
    public void getBuildList(final String cityName,
                    ...
                    public void onFinished(RMBuildList result) {
                        ...
                        if (result.getError_code() == 0) {
                            ...
                            if (cityInfos != null && cityInfos.size() != 0) {
                                buildInfos.addAll(cityInfos.get(0).getBuildlist());
                            }
                            SharePrefUtil.saveObj(AppContext.instance(),
     ...
     * @param listener
     */
    public void getBuildDetail(final String buildId,
                               final OnRmGetFinishListener listener) {
        if (listener == null) {
            return;
        }
    ...
    public void getPrivateBuildList(String userName, String passWord, final OnRmGetFinishListener listener) {
        ...
        httpUtils.send(HttpRequest.HttpMethod.POST, url, params, new RequestCallBack<String>() {
            ...
            public void onSuccess(ResponseInfo<String> responseInfo) {
                ...
                List<PrivateBuild> privateBuilds = new ArrayList<>();
