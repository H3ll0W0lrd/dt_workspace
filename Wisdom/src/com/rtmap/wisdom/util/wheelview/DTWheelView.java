...
public class DTWheelView extends View {
	...
	private void initData(Context context) {
		ADDITIONAL_ITEM_HEIGHT = context.getResources().getDimensionPixelSize(
				R.dimen.wheel_item_size);// 每一项增加的高度
		ITEM_TEXT_SIZE = context.getResources().getDimensionPixelSize(
				R.dimen.wheel_item_size);// 每一项的大小
		VALUE_TEXT_SIZE = context.getResources().getDimensionPixelSize(
				R.dimen.wheel_item_size);// 值的大小
		ITEMS_TEXT_COLOR = context.getResources().getColor(android.R.color.black);
		VALUE_TEXT_COLOR = context.getResources().getColor(android.R.color.black);
