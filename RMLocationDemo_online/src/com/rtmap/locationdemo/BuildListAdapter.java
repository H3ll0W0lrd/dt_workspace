...
public class BuildListAdapter extends BaseExpandableListAdapter {
	...
	public void addList(ArrayList<BuildInfo> list) {
	...
	public void removeItem(BuildInfo info) {
		if(mFloorList.contains(info)){
			mFloorList.remove(info);
		}
	}
	...
	public int getChildrenCount(int groupPosition) {
		if (mFloorList.get(groupPosition).getFloorlist() != null)
	...
	public View getGroupView(int groupPosition, boolean isExpanded,
		...
		BuildInfo info = mFloorList.get(groupPosition);
		holder.mTextMap.setText(info.getBuildName() + "-" + info.getName_qp()
				+ "-" + info.getName_jp());
		return convertView;
	}
