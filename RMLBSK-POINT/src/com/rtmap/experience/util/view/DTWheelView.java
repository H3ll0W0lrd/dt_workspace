 ...
 */
public class DTWheelView extends View {
	/** Scrolling duration */
	private static final int SCROLLING_DURATION = 50;
	...
	/** Text size */
	public int ITEM_TEXT_SIZE;
	public int VALUE_TEXT_SIZE;
	 ...
	 * Constructor
	 */
	public DTWheelView(Context context, AttributeSet attrs, int defStyle) {
	 ...
	 * Constructor
	 */
	public DTWheelView(Context context, AttributeSet attrs) {
		super(context, attrs);
		initData(context);
	}
	 ...
	 * Constructor
	 */
	public DTWheelView(Context context) {
		super(context);
		initData(context);
	}
	...
	private void initData(Context context) {
		ADDITIONAL_ITEM_HEIGHT = context.getResources().getDimensionPixelSize(
				R.dimen.dt_alarm_set_space_size);// 每一项增加的高度
		ITEM_TEXT_SIZE = context.getResources().getDimensionPixelSize(
				R.dimen.dt_alarm_set_item_size);// 每一项的大小
		VALUE_TEXT_SIZE = context.getResources().getDimensionPixelSize(
				R.dimen.dt_alarm_set_value_size);// 值的大小
		ITEMS_TEXT_COLOR = context.getResources().getColor(R.color.dt_alarm_set_item_text_color);
		VALUE_TEXT_COLOR = context.getResources().getColor(R.color.dt_alarm_set_value_text_color);
//		DTLog.error("ADDITIONAL_ITEM_HEIGHT:" + ADDITIONAL_ITEM_HEIGHT);
	...
	private void initResourcesIfNecessary() {
		if (itemsPaint == null) {
			...
			itemsPaint.setTextSize(ITEM_TEXT_SIZE);
		}
	...
	private void drawValue(Canvas canvas) {
		valuePaint.setColor(VALUE_TEXT_COLOR);// 设置值的字体颜色
		...
		if (valueLayout != null) {
			...
			canvas.translate(0, bounds.top + scrollingOffset
					- (VALUE_TEXT_SIZE - ITEM_TEXT_SIZE) / 2);
	...
	private void drawItems(Canvas canvas) {
		...
		itemsPaint.setColor(ITEMS_TEXT_COLOR);// 修改字体颜色
