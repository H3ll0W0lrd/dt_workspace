...
public class DTUIUtils {
	...
	public static Context getContext() {
		return KPApplication.getInstance();
	}

	public static Thread getMainThread() {
		return KPApplication.getMainThread();
	}

	public static long getMainThreadId() {
		return KPApplication.getMainThreadId();
	}
	...
	public static Handler getHandler() {
		return KPApplication.getMainThreadHandler();
	}
	...
	public static void startActivity(Intent intent) {
		KPActivity activity = KPActivity.getForegroundActivity();
		if (activity != null) {
	...
	private static void showToast(String str) {
		KPActivity frontActivity = KPActivity.getForegroundActivity();
