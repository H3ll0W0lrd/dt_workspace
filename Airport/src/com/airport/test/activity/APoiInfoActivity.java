...
public class APoiInfoActivity extends DTActivity implements OnClickListener,
		OnGetPoiDescListener {
	private ImageView imgBack;
	private TextView mPoiName, mAddress, mPhone, mCate, mTime, mMoney, mDesc;
	private RelativeLayout mCome, mGo;
	private ImageView mPhoto, mLogo;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mLogo = (ImageView) findViewById(R.id.image);
		...
		mAddress.setText(poi.getAddress());
		mCate.setText(poi.getClassname());
		mTime.setText(poi.getHours());
		mMoney.setText(poi.getCurrecy());
		mDesc.setText(poi.getDesc());
		ImageLoader.getInstance().loadImage(poi.getPoiImage(),
				new ImageLoadingListener() {
					...
					public void onLoadingComplete(String arg0, View arg1,
						...
						int height = (int) (width*1.0*arg2.getHeight()/arg2.getWidth());
						LayoutParams p = (LayoutParams) mPhoto.getLayoutParams();
						p.height = height;
						mPhoto.setLayoutParams(p);
		...
		ImageLoader.getInstance().loadImage(poi.getLogoImage(),
				new ImageLoadingListener() {
