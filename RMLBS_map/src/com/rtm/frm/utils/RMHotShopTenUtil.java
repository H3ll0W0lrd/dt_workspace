...
public class RMHotShopTenUtil {
	...
	private final static String SEARCHSHOPTEN="RMHotShopTenUtil.searchShopTen";
	 ...
	 * @return 本类对象
	 */
	public RMHotShopTenUtil setOnSearchPoiListener(
	...
	private class CheckCall implements RMCallBack {
		...
		public Object onCallBackStart(Object... obj) {
			...
			route.setInterfaceName(SEARCHSHOPTEN);
			try {
