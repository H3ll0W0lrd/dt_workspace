...
import com.rtmap.locationcheck.page.LCBeaconNoLBSActivity;
import com.rtmap.locationcheck.page.LCBitampBeaconNoLBSActivity;
import com.rtmap.locationcheck.page.LCLocationPointActivity;
import com.rtmap.locationcheck.page.LCLocationRouteActivity;
import com.rtmap.locationcheck.page.LCLoginActivity;
	...
	private void showInter(final Floor floor) {
		...
		mInterList.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1,
				...
				switch (position) {
				case 1://矢量图采集
					intent.setClass(LCMapListNewActivity.this,
