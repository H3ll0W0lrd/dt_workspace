...
public class DTUIUtils {
	...
	public static Context getContext() {
		return LCApplication.getInstance();
	}

	public static Thread getMainThread() {
		return LCApplication.getMainThread();
	}

	public static long getMainThreadId() {
		return LCApplication.getMainThreadId();
	}
	...
	public static Handler getHandler() {
		return LCApplication.getMainThreadHandler();
	}
	...
	public static void startActivity(Intent intent) {
		LCActivity activity = LCActivity.getForegroundActivity();
		if (activity != null) {
	...
	private static void showToast(String str) {
		LCActivity frontActivity = LCActivity.getForegroundActivity();
