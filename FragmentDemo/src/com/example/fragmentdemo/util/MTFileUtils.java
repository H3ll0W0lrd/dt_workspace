...
public class MTFileUtils {
	...
	public static final String ROOT_DIR = "bailumei";
	...
	public static String getCachePath() {
		File f = MTUIUtils.getContext().getCacheDir();
		if (null == f) {
			return null;
		} else {
	...
	public static void writeProperties(String filePath, String key,
		...
		if (MTStringUtils.isEmpty(key) || MTStringUtils.isEmpty(filePath)) {
			return;
		}
	...
	public static void writeMap(String filePath, Map<String, String> map,
		...
		if (map == null || map.size() == 0 || MTStringUtils.isEmpty(filePath)) {
			return;
		}
		FileInputStream fis = null;
		FileOutputStream fos = null;
	...
	public static Map<String, String> readMap(String filePath,
			String defaultValue) {
		if (MTStringUtils.isEmpty(filePath)) {
			return null;
		}
