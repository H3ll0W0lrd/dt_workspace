...
public class MTIOUtils {
	...
	public static File rotaingImageView(String fileUrl, Context context) {
		...
		MTLog.i("outWidth:" + options.outWidth + "     outHeight:"
				+ options.outHeight);
		if (options.outWidth <= IMAGE_AVATAR_SIZE && options.outHeight <= IMAGE_AVATAR_SIZE) {// 如果宽高都小于规定尺寸
			...
			MTLog.i("options.inSampleSize: " + options.inSampleSize);
		}
		...
		File file = MTFileUtils.getImageFile();
